...
class DataSet(data.Dataset):
    def __init__(self,datapath='/home/fanyuying/two_streams_data/训练1声音分帧',train=True,filter_r=3,sigma=1):
    ...
    def __getitem__(self,index):
        ...
        return (torch.from_numpy(np.array(data)).float().view(4,-1), label)  ##cnn
