...
model=dense.TCN(input_size=4,output_size=4, num_channels= [12,12,24,32,48,64] , kernel_size=7, dropout=0.3)
model.load_state_dict(torch.load('/home/fanyuying/dense1/shengyin/weights_eemd/z_model149.pth')['model_state_dict'])
model.eval()
...
pathZ=r'/home/fanyuying/two_streams_data/EEMD算法分类/测试声音'
...
#            
        ...
        savepath=os.path.join(r'/home/fanyuying/dense1/shengyin/测试结果图emd', filez[i].split('.')[-2].split('/')[-1]+'.png')
